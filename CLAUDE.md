...
- `components/MenuScreen.tsx` - メニュー画面（Bluetooth・OBD2・GPS・DTCs・Values・各設定画面への遷移）
...
**メニュー画面（5x4 グリッド）:**
- Bluetooth / OBD2 / Display Settings / Layout Editor / Theme Editor / System Settings / Terminal / Dev Settings / DTCs / GPS / Values / About
- 背景タップでダッシュボードに戻る
...
- GPIO（イルミ: ピン・論理・テーマ選択・GPIO 状態(HIGH/LOW)・発動状態(ON)、リバース: 同様、USB リセット: ピン選択）
