...
- `components/MenuScreen.tsx` - メニュー画面（Bluetooth・OBD2・GPS・DTCs・各設定画面への遷移）
...
**メニュー画面（3x3 グリッド）:**
- Bluetooth / OBD2 / Display Settings / Layout Editor / Theme Editor / System Settings / Dev Settings / DTCs / GPS
- 背景タップでダッシュボードに戻る
