export type Screen = 'dashboard' | 'menu' | 'system-settings' | 'display-settings' | 'board-settings' | 'layout-editor' | 'dev-settings' | 'theme-editor' | 'bluetooth' | 'obd2' | 'dtc' | 'gps' | 'values' | 'about' | 'terminal';
